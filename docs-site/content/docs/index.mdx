...
<Cards>
  ...
  <Card
    ...
    description="Kill switch and P&L based exit for risk management"
  />
  <Card
    title="Conditional Triggers"
    href="/docs/api-reference/conditional-triggers"
    description="Price and indicator based alerts that auto-place orders"
  />
  <Card
    title="Scanner"
...
| **tradersControl** | Kill switch and P&L based exit | [View →](/docs/api-reference/traders-control) |
| **conditionalTriggers** | Price/indicator alerts that auto-place orders | [View →](/docs/api-reference/conditional-triggers) |
